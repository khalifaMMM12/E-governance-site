...
$queryID  = "SELECT * FROM `identify`";

$IDStmt = mysqli_prepare($conn, $queryID);

mysqli_stmt_execute($IDStmt);

$results = mysqli_stmt_get_result($IDStmt);
        ...
        <main class="container">
         ...
         <section class="hero">
              <div class="content">
                ...
                <div class="hero-btn">
                    <a href="anonymous-admin.php" class="btn">Anonymous</a> <a href="#" class="btn">Identified</a>
                    </center>
                </div>
                </div>       
               </div>
