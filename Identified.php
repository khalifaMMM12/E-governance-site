...
if (isset($_POST['submitComplain'])) {
    ...
    $IDQuery = "INSERT INTO `identify`(`name`, `number`, `local government`, `ministry`, `complain`, `date`, `images`) VALUES (?, ?, ?, ?, ?, ?, ?)";

    $IDStmt = mysqli_prepare($conn, $IDQuery);

    mysqli_stmt_bind_param($IDStmt, "sssssss", $name, $num, $lga, $min, $text, $datetime, $img);
...
<head>
    ...
    <title>identified Complains</title>
</head>
<body>
        <!--==== NAV-BAR ====-->
        <header class="header">
        ...
        <main class="container">
            ...
            <div class="complain-box">
                <h2>Identified Complain / Suggestions</h2>
                <p>fill the form with identified Complains or Suggestions on improving the <b>NIGER STATE</b> Government</p>
                ...
                <form action="#" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select id="L-government" name="local-government">
                    ...
                    <textarea rows="5" name="text" placeholder="Type detailed complain with specific point" required></textarea>
                    ...
                    <div class="img-upload">
                        ...
                        <output id="img_output">
                    </div>


                    <button class="btn-1" type="submit" name="submitComplain">Submit Complain</button>
                    <a class="sub_link" href="Anonymous.php">Anonymous Complain</a>
                </form>
            </div>
             <!-- FORM END --> 
